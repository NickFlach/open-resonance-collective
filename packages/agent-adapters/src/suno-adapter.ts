 ...
 */
export class SunoAdapter extends EventEmitter implements AgentAdapter {
  public readonly name = 'suno';
  public readonly displayName = 'Suno AI';
   ...
   */
  private translatePromptToSuno(prompt: AgentPrompt): string {
   ...
   */
  private getPhaseInstructions(phase: ConsciousnessPhase) {
    const instructions = {
      'ghost-signals': {
   ...
   */
  private getTechnicalSpecs(constraints: TrackConstraints): string[] {
    const specs: string[] = [];
   ...
   */
  private createRemixPrompt(stem: Stem, prompt: AgentPrompt): string {
   ...
   */
  private async mockSunoAuth(): Promise<void> {
   ...
   */
  private async mockSunoGenerate(prompt: string, constraints: TrackConstraints): Promise<any> {
   ...
   */
  private async mockSunoRemix(stem: any, prompt: string, constraints: TrackConstraints): Promise<any> {
   ...
   */
  private async mockSunoHealthCheck(): Promise<void> {
   ...
   */
  private async convertStemForSuno(stem: Stem): Promise<any> {
   ...
   */
  private convertSunoResponseToTrack(sunoResponse: any, prompt: AgentPrompt, startTime: number): GeneratedTrack {
